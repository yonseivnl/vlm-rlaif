...
class BinaryRewardModelingDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "images" in sources[0]:
            ...
            _sources = preprocess_multimodal(copy.deepcopy([e["conversations"] for e in sources]), self.data_args)
...
def make_binary_reward_modeling_data_module(tokenizer: transformers.PreTrainedTokenizer, data_args, training_args,):
